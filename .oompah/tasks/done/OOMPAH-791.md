...
updated_at: '2026-08-10T01:20:54.049135Z'
...
oompah.terminal_audit:
  ...
  applied_result_attempts:
    attempt-c29149f92ba2: '2026-08-06T06:07:40.999851+00:00'
  oompah.terminal_audit_retirements:
  - project_id: proj-14849f1b
    task_id: OOMPAH-791
    target_state: Done
    evidence_fingerprint: 4887e4e96cbf76084f97b22979ef1ac4b142c181bb186157468db69403cd7eba
    audit_ids:
    - audit-d2f7974e6616
    kind: result
    applied: true
    retired_at: '2026-08-06T06:07:40.999862+00:00'
  ...
  oompah.terminal_provenance_suppression:
    ...
    reason: Historical audited Done record lacks safe exact current landing proof;
      ...
      creating new work.
    marked_at: '2026-08-10T01:20:52.335707+00:00'
    updated_at: '2026-08-10T01:20:52.335707+00:00'
    history:
    - kind: mark
      actor:
        version: 1
      ...
      reason: Historical audited Done record lacks safe exact current landing proof;
        retain immutable terminal provenance and retire recurring reassessment without
        creating new work.
      recorded_at: '2026-08-10T01:20:52.335707+00:00'
      authority_generation: 0
    actor:
      version: 1
      identity: oompah-cli
  ...
  - version: 1
    ...
    - version: 1
      ...
      evidence_fingerprint:
        ...
        algorithm: sha256
        digest: 4887e4e96cbf76084f97b22979ef1ac4b142c181bb186157468db69403cd7eba
      created_at: '2026-08-06T05:18:41.845420+00:00'
      provider_id: prov-651d553c
      model: opus
    ...
    - version: 1
      ...
      verdict: pass
      completed_at: '2026-08-06T06:07:40.999688+00:00'
      ended_at: '2026-08-06T06:07:40.999688+00:00'
    requested_by:
      version: 1
    ...
    updated_at: '2026-08-06T06:07:40.999688+00:00'
    source_generation: 1
  attempt_history:
  - version: 1
    attempt_id: attempt-50dea84e66e3
...
---
author: oompah
created: 2026-08-06 04:29
---
The combined-tree quality gate failed on `epic-OOMPAH-768--task-OOMPAH-791`. Fix the failure on that private branch, run the full configured quality gate, push, and `oompah task submit` it again.

Gate output:
```
stForwarderProcessFullLifecycle::test_process_start_and_immediate_exit
  /home/shedwards/.oompah/tmp/oompah-quality-gate-5q5en4on/workspace/.venv/lib/python3.12/site-packages/_pytest/unraisableexception.py:67: PytestUnraisableExceptionWarning: Exception ignored in: <function BaseSubprocessTransport.__del__ at 0x7c74de2039c0>
...
tests/test_websocket_authenticated_bootstrap.py::TestWebSocketBootstrapIncludesAuth::test_ws_bootstrap_includes_build_id
  /home/shedwards/.oompah/tmp/oompah-quality-gate-5q5en4on/workspace/.venv/lib/python3.12/site-packages/_pytest/unraisableexception.py:67: PytestUnraisableExceptionWarning: Exception ignored in: <function BaseSubprocessTransport.__del__ at 0x734c68b479c0>
