...
oompah.agent_run_id: 8dddf63e-fbc6-46ec-a0e0-bcddfd49cec0
oompah.task_costs:
  total_input_tokens: 628
  total_output_tokens: 18628
  total_cost_usd: 0.0
  by_model:
    unknown:
      input_tokens: 628
  ...
  - profile: default
    ...
    output_tokens: 5600
    cost_usd: 0.0
    recorded_at: '2026-06-20T05:17:48.550094+00:00'
...
Target branch: `main`
Unmerged commits: 2 commits
  702ef6f OOMPAH-6: Fix create_review 422 idempotency — return existing PR on 'already exists'
  961222b OOMPAH-6: Add TrackerAuthError and surface GitHub intake auth failures as actionable alerts
