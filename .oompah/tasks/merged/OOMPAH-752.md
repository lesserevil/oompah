...
oompah.task_costs:
  ...
  - profile: auditor
    ...
    output_tokens: 5537
    cost_usd: 0.0
    recorded_at: '2026-08-04T02:41:10.905107+00:00'
  - profile: auditor
    model: unknown
    input_tokens: 29
    output_tokens: 1069
...
oompah.review_url: https://github.com/lesserevil/oompah/pull/700
...
oompah.terminal_audit:
  ...
  - project_id: proj-14849f1b
    ...
    applied_at: '2026-08-04T02:50:32.846813+00:00'
  version: 1
  pending_chain:
  - version: 1
    audit_id: audit-23ab74084109
    ...
    - version: 1
      ...
      evidence_fingerprint:
        ...
        algorithm: sha256
        digest: 40e0d5b46c5fba3c67f60c445ffe7cada4ddea298e85979faaae425f5fd12886
      created_at: '2026-08-04T02:34:25.331550+00:00'
      provider_id: prov-651d553c
      model: opus
      started_at: '2026-08-04T02:34:25.331550+00:00'
      branch_key: OOMPAH-752
      verdict: pass
      completed_at: '2026-08-04T02:40:24.889774+00:00'
      ended_at: '2026-08-04T02:40:24.889774+00:00'
    requested_by:
      version: 1
      identity: lesserevil
      source: forge
    ...
    updated_at: '2026-08-04T02:40:24.889774+00:00'
  - version: 1
    audit_id: audit-1783e534c137
    project_id: proj-14849f1b
    task_id: OOMPAH-752
    ...
    attempts:
    - version: 1
      attempt_id: attempt-6011b6c712d2
      target_state: Merged
      ...
      evidence_fingerprint:
        ...
        algorithm: sha256
        digest: 40e0d5b46c5fba3c67f60c445ffe7cada4ddea298e85979faaae425f5fd12886
      created_at: '2026-08-04T02:42:10.690146+00:00'
      provider_id: prov-651d553c
      model: opus
      started_at: '2026-08-04T02:42:10.690146+00:00'
      branch_key: OOMPAH-752
      failure_classification: policy_incompatibility
      ended_at: '2026-08-04T02:44:41.100995+00:00'
      failure_reason: 'read-only auditor exceeded the policy-denial limit (3): Error:
        auditor capability policy permits only read-only repository inspection and
        configured test commands; command denied'
      next_retry_at: '2026-08-04T02:44:51.100967+00:00'
    - version: 1
      attempt_id: attempt-12eb428625b1
      target_state: Merged
      request_state: completed
      evidence_fingerprint:
        ...
        algorithm: sha256
        digest: 40e0d5b46c5fba3c67f60c445ffe7cada4ddea298e85979faaae425f5fd12886
      created_at: '2026-08-04T02:44:53.470381+00:00'
      provider_id: prov-651d553c
      model: sonnet
...
- merge_commit: bc9c289f4 Merge pull request #700 from lesserevil/OOMPAH-752
- ancestor_of_main: true
- focused_tests_passed: 60 (35 standalone + 25 review-capacity/integration-queue)
- code_helpers_added: _standalone_delivery_order_key, _arm_standalone_capacity_wait
- regression_tests_added: test_standalone_delivery_selects_priority_then_submitted_fifo; test_invalid_old_candidate_falls_through_without_claiming_later_rows; test_dependency_blocked_candidate_does_not_claim_or_block_next
- diff_scope: oompah/orchestrator.py (+201/-65 combined via merge), tests/test_standalone_ready_to_integrate.py (+136 net additions)
---
author: oompah
...
- Tokens: 30 in / 5.5K out [5.6K total]
- Cost: $0.0000
- Exit: normal, Duration: 6m 34s
- Log: OOMPAH-752__20260804T023444Z.jsonl
---
author: oompah
created: 2026-08-04 02:42
---
Auditor dispatched (attempt #1, candidate: prov-651d553c/opus)
---
author: oompah
...
- Tokens: 29 in / 1.1K out [1.1K total]
- Cost: $0.0000
- Exit: terminated, Duration: 2m 26s
- Log: OOMPAH-752__20260804T024220Z.jsonl
---
author: oompah
created: 2026-08-04 02:44
---
