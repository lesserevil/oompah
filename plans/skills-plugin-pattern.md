...
| | Decision |
|---|---|
| **a. Layered, not replacing** | New native skills sit alongside `run_command`. `bd_*` / `git_*` skills (when they exist) are preferred but the bd cheat sheet stays in WORKFLOW.md as a fallback. |
