...
BUILTIN_FOCI: list[Focus] = [
    ...
    Focus(
        ...
        must_not_do=[
            ...
            "Comment, label, archive, close, change the task status directly, "
            "or otherwise mutate any task",
            "Write, edit, delete, commit, push, or otherwise modify repository files",
        ],
        keywords=[
