...
class WorkflowFactCollector:
    ...
    def _overlay_integration_queue(
        ...
        """Overlay exact-head durable integration state onto tracker facts."""
        ...
        if (
            authoritative_head
            and queue_head
            and str(queue_head) != str(authoritative_head)
        ):
            return tracker_value
        ...
        base: dict[str, Any] = (
            dict(tracker_value) if tracker_value is not None else {}
        )
