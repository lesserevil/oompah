...
_REASONS = (
    ...
    _reason(
        ...
        "operator_visibility",
        ("owner_ids", "task_id"),
        "Multiple ownership claims cannot safely be reconciled automatically.",
        remedy="Revoke the stale claim or choose the single authoritative owner.",
    ),
    _reason(
        ...
        "operator_visibility",
        ("task_id",),
        "No safe ownership authority can be established for the task.",
        remedy="Repair the ownership record and provide one valid authority.",
    ),
    _reason(
        "graph.impossible",
        set(CANONICAL_STATUSES) - set(LIFECYCLE_FINAL_STATUSES),
        ...
        ResponsibleSubsystem.OPERATOR,
        "operator_visibility",
        ("task_id", "cycle_members"),
        "The dependency graph contains a cycle that cannot make progress.",
        remedy="Break the named dependency cycle before dispatch can continue.",
    ),
    _reason(
        "retry.exhausted",
        set(CANONICAL_STATUSES) - set(LIFECYCLE_FINAL_STATUSES),
        ...
        "operator_visibility",
        ("task_id", "attempts"),
        "Automatic recovery used its bounded attempt budget.",
        remedy="Inspect the recorded failure evidence and choose a recovery action.",
    ),
    _reason(
        ...
        "operator_visibility",
        ("task_id",),
        "The workflow needs recovery but no durable recovery action is available.",
        remedy="Install or repair the responsible recovery worker.",
    ),
    _reason(
        ...
        "operator_visibility",
        ("task_id",),
        "One snapshot contained conflicting task facts.",
        remedy="Reconcile the task snapshot before allowing an automatic transition.",
    ),
    _reason(
        ...
        "operator_visibility",
        ("task_id", "error"),
        "The controller could not safely evaluate the task evidence.",
        remedy="Repair the evidence source and rerun the bounded workflow pass.",
    ),
    _reason(
        "landing.waiting",
        {DONE},
