...
class AuditorDispatchLane:
    ...
    def recover(
        ...
        *,
        ...
        attempt absent from that set is abandoned immediately (including after
        a process restart), while a live worker remains owned by its
        phase-specific liveness deadlines. Callers without a live-worker
        registry can omit the set and use the TTL grace period instead. A
        changed fingerprint is never allowed to complete an old attempt.
        """
